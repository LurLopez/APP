...
- **Guía completa en español**: `documentacion/referencias/clean-code-javascript/README_es.md` (o `.agents/skills/mejorespracticas/references/README_es.md`)
- **Guía original en inglés**: `documentacion/referencias/clean-code-javascript/README.md`

Consúltalos cuando necesites consultar patrones concretos (SOLID en JS, manejo de concurrencia, encapsulación de clases, etc.).
