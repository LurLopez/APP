...
window.updateValuationMeasurementView = updateValuationMeasurementView;
window.onValMeasurePointerMove = onValMeasurePointerMove;
window.onValMeasurePointerUp = onValMeasurePointerUp;
window.getValChartPointIndex = getValChartPointIndex;
