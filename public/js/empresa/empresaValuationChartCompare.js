...
window.updateValComparisonView = updateValComparisonView;
window.startValComparison = startValComparison;
window.onValComparePointerMove = onValComparePointerMove;
window.onValComparePointerUp = onValComparePointerUp;
window.clearValComparison = clearValComparison;
