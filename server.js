...
import metricFavoritesRoutes from './src/api/routes/metricFavorites.routes.js';
import hiddenSeriesRoutes from './src/api/routes/hiddenSeries.routes.js';
...
app.use('/api/metric-favorites', metricFavoritesRoutes);
app.use('/api/hidden-series', hiddenSeriesRoutes);
