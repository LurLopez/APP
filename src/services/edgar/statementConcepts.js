...
export const STATEMENTS = {
  ...
  balance: [
    ...
    { key: 'shortTermLoans', label: 'Préstamos de corto plazo', tags: ['ShortTermBorrowings', 'ShortTermDebt', 'LinesOfCreditCurrent', 'CommercialPaper', 'OtherShortTermBorrowings', 'NotesAndLoansPayableCurrent', 'CommercialPaperCurrent', 'LinesOfCredit', 'ShortTermBankLoansAndOtherBorrowings', 'NotesPayableCurrent', 'DebtCurrent'], unit: 'USD' },
