...
export const STATEMENTS = {
  ...
  income: [
    ...
    { key: 'ebtIncludingUnusual', label: 'EBT incl. Artículos extraordinarios', tags: ['IncomeLossFromContinuingOperationsBeforeIncomeTaxesExtraordinaryItemsNoncontrollingInterest', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxesMinorityInterestAndIncomeLossFromEquityMethodInvestments', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxes', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxesDomestic', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxesForeign', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxesMinorityInterest', 'IncomeLossFromContinuingOperationsBeforeIncomeTaxesOtherThanTemporaryImpairments'], unit: 'USD', emphasis: true },
  ...
  balance: [
    ...
    { key: 'restrictedCash', label: 'Efectivo restringido', tags: ['RestrictedCashAndCashEquivalentsAtCarryingValue', 'RestrictedCashAndCashEquivalentsCurrent', 'RestrictedCash', 'RestrictedCashAndCashEquivalentsNoncurrent', 'RestrictedCashCurrent', 'RestrictedCashNoncurrent', 'RestrictedCashAndInvestmentsCurrent'], unit: 'USD' },
    ...
    { key: 'longTermDebtCurrent', label: 'Porción corriente de la deuda a largo plazo', tags: ['LongTermDebtCurrent', 'LongTermDebtAndCapitalLeaseObligationsCurrent', 'LongTermDebtAndFinanceLeasesCurrent', 'LongTermDebtCurrentNoncurrent', 'LongTermDebtMaturingInYearsOneAndTwo', 'CurrentPortionOfLongTermDebt', 'FinanceLeaseLiabilityCurrent'], unit: 'USD' },
  ...
  cashflow: [
    ...
    { key: 'acquisitions', label: 'Adquisiciones con efectivo', tags: ['PaymentsToAcquireBusinessesNetOfCashAcquired', 'PaymentsToAcquireBusinessesAndInterestInAffiliates', 'PaymentsToAcquireBusinesses', 'PaymentsToAcquireOtherInvestments', 'PaymentsToAcquireInterestInJointVenture', 'PaymentsToAcquireAffiliates', 'PaymentsToAcquireProductiveAssets'], unit: 'USD', negative: true },
